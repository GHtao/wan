...
import me.yokeyword.fragmentation.swipeback.core.ISwipeBackActivity;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public void attachToActivity(FragmentActivity activity) {
        ...
        a.recycle();
        //把decor view中的content找出来移除掉，将swipe back添加之前移除的content
        // 再让decor添加swipe back view
        ...
        public boolean tryCaptureView(View child, int pointerId) {
            ...
            if (dragEnable) {
                ...
                if (mPreFragment == null) {
                    if (mFragment != null) {
                        List<Fragment> fragmentList = FragmentationMagician
                                .getActiveFragments(((Fragment) mFragment).getFragmentManager());
            ...
            if(mFragment != null && mPreFragment == null){
                return false;
            }
            return dragEnable;
        }
